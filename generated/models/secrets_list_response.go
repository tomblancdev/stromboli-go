...
func (m *SecretsListResponse) validateSecrets(formats strfmt.Registry) error {
...
func (m *SecretsListResponse) contextValidateSecrets(ctx context.Context, formats strfmt.Registry) error {
