...
func (m *ImageSearchResponse) validateResults(formats strfmt.Registry) error {
...
func (m *ImageSearchResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
