...
func (m *SessionMessageResponse) validateMessage(formats strfmt.Registry) error {
...
func (m *SessionMessageResponse) contextValidateMessage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SessionMessageResponse) UnmarshalBinary(b []byte) error {
	var res SessionMessageResponse
