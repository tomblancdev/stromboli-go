...
func (o *GetClaudeStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetClaudeStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /claude/status] GetClaudeStatus", response, response.Code())
	}
}

// NewGetClaudeStatusOK creates a GetClaudeStatusOK with default headers values
func NewGetClaudeStatusOK() *GetClaudeStatusOK {
	return &GetClaudeStatusOK{}
}
...
func (o *GetClaudeStatusOK) Error() string {
	...
	return fmt.Sprintf("[GET /claude/status][%d] getClaudeStatusOK %s", 200, payload)
}
...
func (o *GetClaudeStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ClaudeStatusResponse)
