...
func (a *Client) GetClaudeStatus(params *GetClaudeStatusParams, opts ...ClientOption) (*GetClaudeStatusOK, error) {
	...
	if params == nil {
		params = NewGetClaudeStatusParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetClaudeStatus",
		Method:             "GET",
		PathPattern:        "/claude/status",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetClaudeStatusReader{formats: a.formats},
	...
	success, ok := result.(*GetClaudeStatusOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetClaudeStatus: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
