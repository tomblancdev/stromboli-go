...
type ClientService interface {
	DeleteJobsID(params *DeleteJobsIDParams, opts ...ClientOption) (*DeleteJobsIDOK, error)
...
/*
DeleteJobsID cancels job

Cancels a pending or running job
*/
func (a *Client) DeleteJobsID(params *DeleteJobsIDParams, opts ...ClientOption) (*DeleteJobsIDOK, error) {
	...
	success, ok := result.(*DeleteJobsIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for DeleteJobsID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetJobsID gets job status

Returns the status and result of an async job
*/
func (a *Client) GetJobsID(params *GetJobsIDParams, opts ...ClientOption) (*GetJobsIDOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetJobsID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
